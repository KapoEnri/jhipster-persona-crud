...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("cl.kapoenri.persona.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("cl.kapoenri.persona.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
